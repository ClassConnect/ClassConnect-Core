...
// -----------------------------------------------
 ...
 if($_SESSION['configfile'] == "") {
 echo '<script type="text/javascript">
jQuery.facebox(\'<br /><center><span class="version"><strong>Error!</strong></span><br /><br /><span class="bartype">You must have cookies enabled in order to send this form!</span></center><br />\')</script>';
 } else {
