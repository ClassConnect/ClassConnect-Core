...
foreach ($students as $student) {
	echo '<div style="height:26px; border-bottom: 1px solid #ccc; margin-top:5px; padding:5px">

<div style="float:left">
<span style="font-size:16px; font-weight:bolder">' . $student['first_name'] . ' ' . $student['last_name'] . '</span>
</div>
