...
if (isset($_POST['name'])) {
	...
	$attempt = update_embed($content['id'], $user_id, $name, $body, $code);
	if ($attempt == 1) {
		echo '1';
	} else {
...
function updateBookmark() {
        ...
        $('#bottom').hide();
        dataString = $("#update-embed").serialize();
        $.ajax({
        type: "POST",
...
echo '<div class="headTitle"><img src="' . $imgServer . 'gen/embed_l.png" style="margin-top:3px; margin-right: 5px" /><div>Edit YouTube Video</div></div>
<div id="failer" style="display:none"></div>
<div id="content" style="margin:5px">
<form method="POST" id="update-embed" style="font-size:14px; margin-top:10px">	
...
<textarea name="code" style="height:50px; width:215px">' . $content['content'] . '</textarea><br /><br />';
