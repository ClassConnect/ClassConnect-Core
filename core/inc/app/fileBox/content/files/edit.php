...
if (isset($_POST['name'])) {
	...
	$attempt = update_file($content['id'], $user_id, $name, $body, $url);
	if ($attempt == 1) {
		echo '1';
	} else {
...
echo '<div class="headTitle"><img src="' . $imgServer . 'gen/upload_l.png" style="margin-top:2px; margin-right: 5px" /><div>Update File</div></div>
