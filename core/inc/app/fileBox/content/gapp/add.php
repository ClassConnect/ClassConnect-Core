...
if (isset($_POST['name'])) {
	...
	$attempt = create_gdoc($fid, $user_id, $name, $url, $body);
	if ($attempt == 1) {
		echo '1';
	} else {
...
echo '<div class="headTitle"><img src="' . $imgServer . 'gen/gaoo_l.png" style="margin-top:4px; margin-right: 10px" /><div>Add Google Doc</div></div>
<div id="failer" style="display:none"></div>
<div id="content" style="margin:5px">
<form method="POST" id="add-bookmark" style="font-size:14px; margin-top:10px">	
<strong>Doc Name</strong> <span style="color:#dd1100;font-style: bolder">*</span><br />
...
<input type="text" name="url" style="width:215px" value="https://" /><br /><br />
...
<div class="infobox" style="margin-top:10px">Make sure this document is publicly accessible when sharing with others.</div>
