...
if (isset($_POST['name'])) {
	...
	$attempt = update_ytvideo($content['id'], $user_id, $name, $body, $url);
	if ($attempt == 1) {
		echo '1';
	} else {
...
echo '<div class="headTitle"><img src="' . $imgServer . 'gen/yt_l.png" style="margin-top:3px; margin-right: 5px" /><div>Edit YouTube Video</div></div>
