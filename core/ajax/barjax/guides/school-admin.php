...
guider.createGuider({
      buttons: [{name: "Close"}],
      buttonCustomHTML: "<a class=\"guider_button\" style=\"float:right\" onClick=\"swapPage(1);myMenu.expandAll(); guider.next();\">Next</a>",
    ...
    guider.createGuider({
      attachTo: "#xoar1",
      buttons: [{name: "Close"}],
      buttonCustomHTML: "<a class=\"guider_button\" style=\"float:right\" onClick=\"swapPage(2);myMenu.expandAll(); guider.next();\">Next</a>",
    ...
    guider.createGuider({
      attachTo: "#xoar2",
      buttons: [{name: "Close"}],
      buttonCustomHTML: "<a class=\"guider_button\" style=\"float:right\" onClick=\"swapPage(5);myMenu.expandAll(); guider.next();\">Next</a>",
    ...
    guider.createGuider({
      attachTo: "#xoar5",
      buttons: [{name: "Close"}],
      buttonCustomHTML: "<a class=\"guider_button\" style=\"float:right\" onClick=\"swapPage(6);myMenu.expandAll(); guider.next();\">Next</a>",
    ...
    guider.createGuider({
      attachTo: "#xoar6",
      buttons: [{name: "Close"}],
      buttonCustomHTML: "<a class=\"guider_button\" style=\"float:right\" onClick=\"swapPage(7);myMenu.expandAll(); guider.next();\">Next</a>",
    ...
    guider.createGuider({
      attachTo: "#xoar7",
      buttons: [{name: "Close"}],
      buttonCustomHTML: "<a class=\"guider_button\" style=\"float:right\" onClick=\"swapPage(8);myMenu.expandAll(); guider.next();\">Next</a>",
    ...
    guider.createGuider({
      attachTo: "#xoar8",
      buttons: [{name: "Close"}],
      buttonCustomHTML: "<a class=\"guider_button\" style=\"float:right\" onClick=\"swapPage(9);myMenu.expandAll(); guider.next();\">Next</a>",
    ...
    guider.createGuider({
      attachTo: "#xoar9",
      buttons: [{name: "Close"}],
      buttonCustomHTML: "<a class=\"guider_button\" style=\"float:right\" onClick=\"swapPage(10);myMenu.expandAll(); guider.next();\">Next</a>",
    ...
    guider.createGuider({
      attachTo: "#xoar10",
      buttons: [{name: "Close"}],
      buttonCustomHTML: "<a class=\"guider_button\" style=\"float:right\" onClick=\"swapPage(12);myMenu.expandAll(); guider.next();\">Next</a>",
    ...
    guider.createGuider({
      attachTo: "#xoar12",
      buttons: [{name: "Close"}],
      buttonCustomHTML: "<a class=\"guider_button\" style=\"float:right\" onClick=\"swapPage(13);myMenu.expandAll(); guider.next();\">Next</a>",
